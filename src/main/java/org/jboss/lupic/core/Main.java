...
public class Main
{
    ...
    private void testImage(Configuration configuration, List<MaskImage> maskImages, String imageFileName, XmlWriter xmlWriter)
    {
        ...
        try
        {
            ...
            ComparisonResult comparisonResult = new ImageComparator().diffImages(imageFileName, sourceImages, maskImages, configuration);
